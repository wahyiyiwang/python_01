...
# python基础-登录功能实现
# 起止时间: 2022/05/25 16:21 ~ 2022/06/18 23:59
# ## 需求-迭代1：登录功能
...
#定义用户默认数据
# user_list = [{'role':'admin','acount':'admin','password':'123456','dept':'tester'},{role':'admin1','acount':'1153573425','password':'336699','dept':'电商'}]
#
# #定义，默认返回结果
